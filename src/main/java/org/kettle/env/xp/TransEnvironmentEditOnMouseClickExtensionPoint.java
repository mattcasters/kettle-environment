...
@ExtensionPoint(
  ...
  id = "TransEnvironmentEditOnMouseClickExtensionPoint",
  description = "Edit the active environment when we click on its name in a transformation" )
public class TransEnvironmentEditOnMouseClickExtensionPoint implements ExtensionPointInterface {
